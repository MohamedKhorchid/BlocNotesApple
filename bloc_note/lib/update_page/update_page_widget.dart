...
class _UpdatePageWidgetState extends State<UpdatePageWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??= TextEditingController(text: widget!.titre);
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??= TextEditingController(text: widget!.contenu);
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await widget!.refNote!.update(createNoteRecordData(
                      ...
                      text: FFLocalizations.of(context).getText(
                        'kkgnrbj3' /* Enregistrer les modifications */,
                      ),
                      icon: Icon(
                        Icons.save,
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'x9l4xhrf' /* Dernière modification: */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
